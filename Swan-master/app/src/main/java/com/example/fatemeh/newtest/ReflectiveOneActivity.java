...
public class ReflectiveOneActivity extends AppCompatActivity {
    String message;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reflective_one);

        //adding background music
        mediaPlayer = MediaPlayer.create(ReflectiveOneActivity.this, R.raw.reflective1);
        mediaPlayer.start();
    ...
    public void Save(View v) {
        ...
        if(Environment.MEDIA_MOUNTED.equals(state)) {
            ...
            File file = new File(Dir,"ReflectionsQ1.txt");
